      ...
      <template v-slot:after>
        ...
        >
          <q-tab-panel name="Lectures">
            <div class="text-h4">Lectures</div>
            <div v-if="!TodayCourses">
              No Courses Found!
            </div>
            <div class="flex flex-center">
              <q-card
                dark
                bordered
                class="bg-grey-9 my-card q-ma-md"
          ...
          <q-tab-panel v-if="UserAdmin" name="Admin">
            ...
            <div class="flex flex-center">
              ...
              <q-card v-if="CoursesFound" class="my-card2 q-pa-md q-ma-sm" @click="Editdialogox">
                <q-img src="https://cdn.quasar.dev/img/parallax2.jpg">
                  <div class="absolute-bottom text-subtitle2 text-center">Edit Course</div>
                  <q-tooltip>Edit a Course</q-tooltip>
                </q-img>
              </q-card>
              <q-card v-if="CoursesFound" class="my-card2 q-pa-md q-ma-sm" @click="Deletedialog=true">
                <q-img src="https://cdn.quasar.dev/img/parallax2.jpg">
                  <div class="absolute-bottom text-subtitle2 text-center">Delete Course</div>
                  <q-tooltip>Delete a Course</q-tooltip>
                </q-img>
              </q-card>
            </div>
                ...
                <q-card class="bg-secondary text-white DialogBox">
                  ...
                  <q-card-section class="q-pt-none text-white">
                    <q-form>
                      ...
                      <span>
                        Lecture Day:
                        <q-select v-model="tmpDay" :options="Days" label="Lecture Day" />
                      </span>
                      <span>
                        Lecture Start Time:
                        <q-input
...
export default {
  ...
  computed: {
    ...mapGetters('stores', ['courses','Tcourses', 'AllcoursesID','UserAdmin']),
